...
vim.keymap.set('n', '<leader>rp', ':w<CR>:botright split | resize 10 | term uv run %<CR>i', { noremap = true, silent = true })
...
vim.api.nvim_create_autocmd('TermOpen', {
  ...
  callback = function()
    ...
    vim.api.nvim_buf_set_keymap(0, 't', '<C-j>', '<C-\\><C-n>j', { noremap = true, silent = true })
    vim.api.nvim_buf_set_keymap(0, 't', '<C-k>', '<C-\\><C-n>k', { noremap = true, silent = true })
  end,
})
...
-- Neovim Lua highlight configuration (equivalent to your original Vimscript)

local set_hl = vim.api.nvim_set_hl
local opts = { bg = 'NONE', fg = 'NONE', ctermbg = 'NONE', ctermfg = 'NONE' }

set_hl(0, 'NonText', { bg = 'NONE', ctermbg = 'NONE' })
set_hl(0, 'Normal', { bg = 'NONE', ctermbg = 'NONE' })
set_hl(0, 'NormalNC', { bg = 'NONE', ctermbg = 'NONE' })
set_hl(0, 'SignColumn', opts)
set_hl(0, 'Pmenu', opts)
set_hl(0, 'FloatBorder', opts)
set_hl(0, 'NormalFloat', opts)
set_hl(0, 'TabLine', opts)
